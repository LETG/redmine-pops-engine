...
function projectParentName () {
  return $("#project_parent_id option:selected").text();
}
...
function autoFillProjectIdentifier() {
  ...
  $('#project_name').keyup(function(){
    if(!locked) {
      $('#project_identifier').val(generateProjectIdentifier((projectParentName() + '-' + projectName()), maxlength));
    }
  });
  ...
  $('#project_identifier').keyup(function(){
    locked = ($('#project_identifier').val() != '' && $('#project_identifier').val() != generateProjectIdentifier((projectParentName() + '-' + projectName()), maxlength));
  });
}
